...
SET USER=CIO
SET PASSWORD=cast
SET REPORTTYPE=Metrics_KPIReport
...
SET CMD="%JAVA_HOME%\bin\java" -jar RestAPIReports-%VERSION%.jar -url %URL% -engDomains %AEDDOMAINS% -user %USER% -password %PASSWORD% -environment %ENVIRONMENT% -reportType %REPORTTYPE% %PROCESSAPPLICATION_FILTER% %VERSION_FILTER%
ECHO running %CMD%
%CMD%
ECHO ========================================
